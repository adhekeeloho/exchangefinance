<template>
  <div class="home">
    ...
    <div> 
        <section>
    <div class=" inset-0 do w-auto bg-image bg-cover bg-center  ">

    </div>
  </section>

   <div class="container us mx-auto py-5 px-4 mt-5">
    <div class="items-center flex flex-wrap">
      <div class="w-full md:w-6/12 ml-auto mr-auto px-4">
        <div class="md:pr-12">
          ...
          <h3 class="text-3xl text-gray-600 font-semibold us">Welcome To <span class="text-emerald-600 let">Exchange
            </span></h3>
          ...
          <ul class="list-none mt-6">
            <li class="py-2">
              <div class="flex items-center">
                <div>
                  <span
                    class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-emerald-600 bg-emerald-300 mr-3"><svg
            ...
            <li class="py-2">
              <div class="flex items-center">
                ...
                <div>
                  <h4 class="text-gray-600">Currency Exchange</h4>
                </div>
              </div>
            </li>
            <li class="py-2">
      ...
      <div class="w-full md:w-6/12 ml-auto mr-auto px-4">
        <img alt="..." class="max-w-full rounded-lg " src="~@/assets/undraw_financial_data_es63.svg" />
      </div>
    </div>
  </div>

  <div class="mt-10">
    <h3 class="text-gray-600 text-3xl py-5 text-center font-semibold us"> <span class="let">Services</span> </h3>
  </div>

  <div class="font-bold bg-slate-50 to px-5 ">
    <ul class="grid us grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 mx-10 my-10">
      <li class="col-span-1 flex flex-col text-center bg-gray-800">
        <div class=" relative">
          <div class=" inset-0  w-full">
            <img class=" w-full object-cover object-center" src="~@/assets/istockphoto-1349094329-612x612.jpg" />
            <div class="flex flex-col flex-1 p-4 mx-auto">
              <h2 class="text-base tracking-normal text-white pb-0 mb-0 tk-brandon-grotesque">Safe & Secure Transactions
              </h2>
            </div>
          </div>
        </div>
      ...
      <li class="col-span-1 flex flex-col text-center bg-gray-800">
        <div class=" relative">
          <div class=" inset-0  w-full">
            <img class=" w-full object-cover object-center" src="~@/assets/istockphoto-1304334908-612x612.jpg" />
            <div class="flex flex-col flex-1 p-4 mx-auto">
              <h2 class="text-base tracking-normal text-white pb-0 mb-0 tk-brandon-grotesque">Smart Exchanges</h2>
            </div>
          </div>
        </div>
      </li>
      <li class="col-span-1 flex flex-col text-center bg-gray-800">
        <div class=" relative">
          <div class=" inset-0  w-full">
            <img class=" w-full object-cover object-center" src="~@/assets/istockphoto-674733552-612x612.jpg" />
            <div class="flex flex-col flex-1 p-4 mx-auto">
              <h2 class="text-base tracking-normal  pb-0 mb-0 tk-brandon-grotesque text-white bold">Expert Support
                Service</h2>
            </div>
          </div>
        </div>
    ...
    <div class="us mx-auto py-5 px-4 mt-10">
    <div class="items-center flex flex-wrap">
      <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
        <div class="md:pr-12 sm:pr-0 sm:justify-center">
          <div
            class=" p-3 text-center inline-flex items-center justify-center w-48 h-48 mb-6  rounded-full text-gray-800 bg-emerald-600 mr-5">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-40 w-40 drop-shadow-2xl" fill="none" viewBox="0 0 24 24"
              stroke="currentColor" stroke-width="2">
          ...
          <div
            class=" p-3 text-center inline-flex items-center justify-center w-48 h-48 mb-6  rounded-full text-gray-800 bg-emerald-600">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-40 w-40 drop-shadow-2xl" fill="none" viewBox="0 0 24 24"
              stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round"
  ...
  <div class=" us bg-gray-800 text-gray-100 px-8 py-12">
    <div
      ...
      <div class="flex flex-col justify-between">
        ...
        <div class="mt-8 text-center">
          <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <defs>
              <linearGradient id="eb6c86d6-45fa-49e0-9a60-1b0612516196" x1="819.07" y1="732.58" x2="819.07" y2="560.46"
                gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                <stop offset="1" stop-color="gray" stop-opacity="0.1" />
              </linearGradient>
              <pattern id="ad310e25-2b04-44c8-bb7b-982389166780" data-name="New Pattern 3" width="36.88" height="49.48"
                patternUnits="userSpaceOnUse" viewBox="0 0 36.88 49.48">
              ...
              <linearGradient id="a964f849-fa65-4178-8cc4-fb8fb10b3617" x1="462.91" y1="660.68" x2="462.91" y2="559.69"
            ...
            <g opacity="0.1">
              ...
              <path
                ...
                transform="translate(-52 -162.63)" fill="#16A34A" />
              <path
            ...
            <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#16A34A" opacity="0.1" />
            <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#16A34A" opacity="0.1" />
            <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#16A34A" opacity="0.1" />
            <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#16A34A" opacity="0.1" />
            <path
              ...
              transform="translate(-52 -162.63)" fill="#16A34A" opacity="0.1" />
            <path
            ...
            <path
              ...
              transform="translate(-52 -162.63)" fill="none" stroke="#3f3d56" stroke-miterlimit="10" stroke-width="4" />
      ...
      <div >
        ...
        <div class="mt-8">
          <button
            class="uppercase text-sm font-bold tracking-wide bg-emerald-600 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
            Send Message
          </button>
        </div>
      </div>
...
<div class="bg-gray-100 us">
    <div class="max-w-screen-lg py-10 px-4 sm:px-6 text-gray-800 sm:flex justify-between mx-auto">
      <div class="p-5 sm:w-2/12 border-r">
        <div class="text-sm uppercase text-emerald-600 font-bold">Menu</div>
        <ul>
          <li class="my-2">
            <a class="hover:text-emerald-600" href="/#">Home</a>
          </li>
          <li class="my-2">
            <a class="hover:text-emerald-600" href="/#">About</a>
          </li>
          <li class="my-2">
            <a class="hover:text-emerald-600" href="/#">Blog</a>
          </li>
        </ul>
      </div>
      <div class="p-5 sm:w-7/12 border-r text-center">
        <h3 class="font-bold text-xl text-emerald-600 mb-4">Finance</h3>
      ...
      <div class="p-5 sm:w-3/12">
        <div class="text-sm uppercase text-emerald-600 font-bold">Contact Us</div>
        <ul>
          <li class="my-2">
            <a class="hover:text-emerald-600" href="/#">XXX XXXX, No 2, Good seed estate, Lagos</a>
          </li>
          <li class="my-2">
            <a class="hover:text-emerald-600" href="/#">contact@company.com</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="flex py-5 m-auto text-gray-800 text-sm flex-col items-center border-t max-w-screen-xl">
      <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
        <a href="/#" class="w-6 mx-1">
          <svg class="fill-current cursor-pointer text-gray-500 hover:text-emerald-600" width="100%" height="100%"
